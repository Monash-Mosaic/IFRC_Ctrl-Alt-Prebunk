...
export function useMDXComponents(_components: MDXComponents): MDXComponents {
  return {
    ...
    p: ({ children, ...props }) => <p className="text-sm leading-relaxed" {...props}>{children}</p>,
    // Line breaks
    br: (props) => <br {...props} />,
    ...
    // Strikethrough text
    del: ({ children, ...props }) => (
      <del className="line-through/60" {...props}>
        {children}
      </del>
    ),
    s: ({ children, ...props }) => (
      <s className="line-through/60" {...props}>
        {children}
      </s>
    ),
    // Monospace text (inline code)
    code: ({ children, ...props }) => (
      <code className="rounded bg-[#E8E9ED] px-1.5 py-0.5 text-xs font-mono" {...props}>
        {children}
      </code>
    ),
    ...
    h4: ({ children, ...props }) => <h4 className="text-base font-semibold" {...props}>{children}</h4>,
    h5: ({ children, ...props }) => <h5 className="text-sm font-semibold" {...props}>{children}</h5>,
    h6: ({ children, ...props }) => <h6 className="text-xs font-semibold" {...props}>{children}</h6>,
    // Lists
    ul: ({ children, ...props }) => (
    ...
    blockquote: ({ children, ...props }) => (
      <blockquote className="border-l-4 border-[#2FE89F] pl-4 italic" {...props}>
        {children}
      </blockquote>
    ),
    ...
    sup: ({ children, ...props }) => (
      <sup className="text-xs leading-none" {...props}>
        {children}
      </sup>
    ),
    ...
    th: ({ children, ...props }) => (
      <th className="border border-[#E8E9ED] px-4 py-2 text-left text-sm font-semibold" {...props}>
        {children}
      </th>
    ),
    td: ({ children, ...props }) => (
      <td className="border border-[#E8E9ED] px-4 py-2 text-sm" {...props}>
        {children}
      </td>
    ),
