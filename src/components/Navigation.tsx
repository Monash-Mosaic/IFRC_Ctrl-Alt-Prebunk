...
export default function Navigation() {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside className="fixed left-0 top-0 z-40 hidden h-screen w-20 flex-col border-r border-[#E8E9ED] bg-white md:flex">
        <nav className="flex flex-1 flex-col justify-center items-center gap-2 pt-24">
          {navItems.map((item) => {
            const isActive =
              pathname === item.href ||
